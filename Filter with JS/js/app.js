...
function mostrarAutos(autos){
    limpiarHTML(); // Elimina contenido previo.
...
//Limpiar HTML previo para mostrar solo filtrados
...
//esta es una funcion de alto nivel (High Order Function) porque pasando como parametro otra funcion
